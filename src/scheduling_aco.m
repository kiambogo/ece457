...
function [best_plan, best_score, it] = scheduling_aco(training_plan, calendar, obj)
    ...
    bucket_paths = linspace(range(1,1), range(1,2), Npaths); % bucket path values
